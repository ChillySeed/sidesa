        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col">
                        <a href="?sort_column=id_dokter&sort_order=<?php echo $new_sort_order; ?>" class="sort-link">Nama Dokter</a>
                    </th>
                    <th scope="col" style="text-align: center;">
                        <a href="?sort_column=NIK&sort_order=<?php echo $new_sort_order; ?>" class="sort-link">Nama Pasien</a>
                    </th>
                    <th scope="col" style="text-align: center;">
                        <a href="?sort_column=tanggal_pengajuan&sort_order=<?php echo $new_sort_order; ?>" class="sort-link">Tanggal Pengajuan</a>
                    </th>
                    <th scope="col" style="text-align: center;">
                        <a href="?sort_column=tanggal_terbit&sort_order=<?php echo $new_sort_order; ?>" class="sort-link">Tanggal Terbit</a>
                    </th>
                    <th scope="col" style="text-align: center;">
                        <a href="?sort_column=status_surat&sort_order=<?php echo $new_sort_order; ?>" class="sort-link">Status Surat</a>
                    </th>
                    <th scope="col" style="text-align: center; color: white;">
                        <a class="judultabel">Isi Surat</a>
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                while ($data = mysqli_fetch_array($hasil)) {
                    $status = $data['status_surat'] == "Disetujui" ? "Disetujui" : ($data['status_surat'] == "Diproses" ? "Diproses" : "Ditolak");
                    echo "<tr>";
                    echo "<td>" . $no . ".</td>";
                    ...
                    echo "<td style='text-align: center;'>" . $data['tanggal_terbit'] . "</td>";
                ...
                ?>
                        ...
                        <!--                         
                            <a href='view.php?id={$data['id_interaksi']}' class='btn btn-info btn-sm'>
                                 <i class='bi bi-eye'></i> View
                            </a>
