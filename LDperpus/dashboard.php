...
<head>
    ...
    <title>SIDESA Layanan Perpustakan</title>
...
<body>
    <div class="dashboard-header">
        <h2>Dashboard - Manajemen Layanan Perpustakaan</h2>
    </div>
    ...
    <div class="container">
        <!-- Buku Pillar -->
        <div class="pillar" style="background-image: url('images/perpus.jpg');">
            <div class="content">
                <h3>Buku</h3>
                <p>Manage Puskesmas records such as adding, editing, or deleting data.</p>
                <a href="buku/index.php" class="btn">Manage Buku</a>
            </div>
        </div>
        ...
        <div class="pillar" style="background-image: url('images/surat.jpg');">
            <div class="content">
                ...
                <a href="pinjam/index.php" class="btn">Manage Peminjaman</a>
            </div>
        </div>
