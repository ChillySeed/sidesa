...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="col-6">
            ...
            $id = $_GET['id_cs'] ?? $_POST['id_cs'] ?? null;

            if ($id) {
                $id = mysqli_real_escape_string($conn, $id);
                $hasil = mysqli_query($conn, "SELECT * FROM customer_support WHERE id_cs='$id'");
                ...
                if (mysqli_num_rows($hasil) > 0) {
                    ...
                    echo "<p class='text-danger'>Error:  not Customer Support found.</p>";
                    exit;
                }
            } else {
                echo "<p class='text-danger'>Error: ID Customer Support not provided.</p>";
                exit;
            }
            ?>
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="id_cs" value="<?php echo $id; ?>" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jadwal_kerja" value="<?php echo $jadwal; ?>">
                </div>
                <div class="form-group">
...
if (isset($_POST['update'])) {
    ...
    $jadwal = mysqli_real_escape_string($conn, $_POST['jadwal_kerja']);

    $query = "UPDATE customer_support 
              SET no_telepon='$telepon', email='$email', jadwal_kerja='$jadwal'
              WHERE id_cs='$id'";
